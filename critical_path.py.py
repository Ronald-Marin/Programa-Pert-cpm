...
print (Style.BRIGHT + Fore.YELLOW + dh +'Autor: Ronald Jefferson Marín Arcentales' + Style.RESET_ALL + dh)
def mainn():
    act = []
    pred = []
    dur = []
    ...
    slister = []
    slister2 = []
    numbe = str(input('\n' +'Ingrese el número de actividades : '))
    term = 0
    if numbe == 'q':
        sys.exit()
    else:
    ...
    for y in range(number):
        x = str(input('Ingrese la actividad, predecesor y duración : '))
    ...
    witt = str(itt) + '\n'
    switt = str(tt) + '\n'
    firstt = ' NUEVOS DATOS CREADOS EL '+ str(curr_date)
    lfirstt = len(firstt) + 5
    spp = ''
    for x in range(0,lfirstt):
        spp += ' '
    ...
    sp = Back.BLACK + '\n' + Style.RESET_ALL
    stimer =  '\n\nNUEVOS DATOS CREADOS EL '\
            + str(curr_date) + '\n' + '\n'
    ssp = '\n'
    firstt = ' ANÁLISIS INDIVIDUAL DE CADA ACTIVIDAD'
    lfirstt = len(firstt) + 5
    spp = ''
    for x in range(0,lfirstt):
        spp += ' '
    ...
    print (Style.BRIGHT + Fore.GREEN + 'El camino crítico es :' , Style.BRIGHT + Fore.RED + cp)
    print (Style.BRIGHT + Fore.GREEN + 'La duración de las actividades en la ruta crítica es :', duration,'min(s)')
    #print color
    #print gantt_graph
    #print (Style.BRIGHT + Fore.YELLOW +"\n...Trazando el gráfico de Gantt, tenga paciencia ....\n")
    ...
    #os.chdir(curr_dir)
    #time.sleep(4)
    #print (Style.BRIGHT + Fore.YELLOW +"...La gráfica se ha trazado con éxito.(femenino)....")
    act = []
    pred = []
    dur = []
    start_act = []
